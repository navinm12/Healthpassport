// var datavalues1 = {{lineChart1values}}
...
$(function () {
    ...
    // Line Chart
    // ------------------------------------------------------ //
    // var linevalues = JSON.parse("{{ lineChart1values|safe }}");
    ...
    //             pointHitRadius: 1,
    //             data: linevalues,
    //             // data:[20, 14, 21, 15, 22, 8, 18, 13, 21, 50, 17, 13, 20, 15],
    //             spanGaps: false
    //         }]
    //     }
    // });
    ...
    // function add_data(){
    //     myLineChart.data.datasets[0].datasets[13] = 50;
    //     myLineChart.data.labels[13] = "newly added";
    //     myLineChart.update();
    // }
    // ------------------------------------------------------- //
    // Line Chart
